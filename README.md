...
(If the link doesn't load, go to the Releases tab in this repository.)
...
- Create user stories with assigned priorities
...
Split the terminal into two terminals (both at `source_code` level)
